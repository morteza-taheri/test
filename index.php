...
.","parse_mode" =>"HTML",'reply_markup' => array(
                'keyboard' => array(array('ارسال پیام به همه🛰'),array('راهنما📜','اعضا👥','مسدود شده ها🚫'),array("تنظیمات⚙")),
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));
            ...
            $video = $message['voice']['file_id'];
            $ttxtt = file_get_contents('pmembers.txt');		$membersidd= explode("\n",$ttxtt);
            for($y=0;$y<count($membersidd);$y++){
...
برای آشنایی دکمه ی  راهنما📜  را بزنید 👌😃
...
.', 'reply_markup' => array(
                'keyboard' => array(array('پاک کردن تمام اعضا❌','پاک کردن تمام مسدود شده ها❌'),array('برگشت')),
                'one_time_keyboard' => true,
                'selective' => true,
                'resize_keyboard' => true)));
        ...
        }else if ($text == "راهنما📜" && $chat_id==$admin) {
...
.","parse_mode" =>"MARKDOWN",'reply_markup' => array(
        ...
        }else if ($text == "پاک کردن تمام اعضا❌" && $chat_id==$admin) {
...
.', 'reply_markup' => array(
        ...
        else if ($text == "پاک کردن تمام مسدود شده ها❌" && $chat_id==$admin) {
...
.","parse_mode" =>"HTML",'reply_markup' => array(
            ...
            $addd = "false";
            file_put_contents('booleans.txt',$addd);
        }else if($text == "اعضا👥" && $chat_id == $admin ){
        ...
        }else if($text == "مسدود شده ها🚫" && $chat_id == $admin ){
